...
describe('shapes', () => {
    ...
    describe('render Triangle text', () => {
        it('should return <text x="150" y="160" font-size="60" text-anchor="middle" fill="white">SVG</text> when shape is Triangle, text color is white, and text is SVG', () => {
            const shape = new Triangle();
            shape.setTextColor("white");
            shape.setText("SVG");
            expect(shape.renderText()).toEqual('<text x="150" y="160" font-size="60" text-anchor="middle" fill="white">SVG</text>');
        });
    });
